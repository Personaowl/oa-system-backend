...
public interface AiRagService {
    ...
    StreamResult answerStream(String question, String knowledgeDomain, Integer topK);
    ...
    record StreamResult(reactor.core.publisher.Flux<String> content,
                        boolean hitFlag,
                        List<Citation> citations,
                        List<MatchedDoc> matchedDocs,
