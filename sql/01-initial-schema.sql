...
CREATE TABLE IF NOT EXISTS sys_user (
    ...
    salary DECIMAL(12,2) NOT NULL DEFAULT 4500.00 COMMENT '职级对应月基础薪资',
    salary_grade VARCHAR(3) NOT NULL DEFAULT '13A' COMMENT '薪资职级：13A至20C',
    performance_salary DECIMAL(12,2) NOT NULL DEFAULT 0.00 COMMENT '月绩效工资',
    deduction_salary DECIMAL(12,2) NOT NULL DEFAULT 0.00 COMMENT '月扣除工资',
    status TINYINT NOT NULL DEFAULT 1 COMMENT '状态：1启用，0禁用',
    created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
    updated_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
    deleted TINYINT NOT NULL DEFAULT 0 COMMENT '逻辑删除标记：0未删除，1已删除',
